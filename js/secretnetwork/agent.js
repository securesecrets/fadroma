...
import { resolve, readFile } from '../sys.js'
...
export default class SecretNetworkAgent {
  ...
  /**get this account's fees (stored on this.API)*/
  get fees () { return this.API.fees }
  /**get this account's address (stored on this.API)*/
  get address () { return this.API.senderAddress }
