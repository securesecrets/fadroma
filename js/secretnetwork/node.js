...
import { freePort, pull, waitUntilLogsSay, waitPort } from '../net.js'
import { dirname, fileURLToPath, resolve, mkdir, existsSync, touch, readFile, writeFile
       } from '../sys.js'
...
export default class SecretNetworkNode {
  ...
  static async spawn (options={}) {
    ...
    const { chainId = "enigma-pub-testnet-3"
          ...
          , init = resolve(__dirname, 'node.init.sh')
